...
function Minter() {
  ...
  async function onSubmit (data) {
    ...
    const imageByteData = [...new Uint8Array(imgArray)]

    const newNFTID = await openXpress.mint(imageByteData, name);
  ...
  return (
    <div className="minter-container">
      <h3 className="Typography-root makeStyles-title-99 Typography-h3 form-Typography-gutterBottom"> Minted! </h3>
